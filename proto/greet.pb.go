...
const file_proto_greet_proto_rawDesc = "" +
	...
	"\tNamesList\x12\x14\n" +
	"\x05names\x18\x01 \x03(\tR\x05names2\xdd\x02\n" +
	"\fGreetService\x12D\n" +
	"\fHelloService\x12\x16.greet_service.NoParam\x1a\x1c.greet_service.HelloResponse\x12T\n" +
	"\x17sayHelloClientStreaming\x12\x1b.greet_service.HelloRequest\x1a\x1a.greet_service.MessageList(\x01\x12S\n" +
	"\x17sayHelloServerStreaming\x12\x18.greet_service.NamesList\x1a\x1c.greet_service.HelloResponse0\x01\x12\\\n" +
...
var file_proto_greet_proto_depIdxs = []int32{
	0, // 0: greet_service.GreetService.HelloService:input_type -> greet_service.NoParam
	1, // 1: greet_service.GreetService.sayHelloClientStreaming:input_type -> greet_service.HelloRequest
	4, // 2: greet_service.GreetService.sayHelloServerStreaming:input_type -> greet_service.NamesList
	1, // 3: greet_service.GreetService.sayHelloBiDirectionalStream:input_type -> greet_service.HelloRequest
	2, // 4: greet_service.GreetService.HelloService:output_type -> greet_service.HelloResponse
